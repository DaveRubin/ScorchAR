...
//            Debug.LogFormat("....{0}X{1}",TerrainGameBoard.terrainData.heightmapWidth,
//                    TerrainGameBoard.terrainData.heightmapHeight);
//
//
//            GameObject cube = PrefabManager.InstantiatePrefab("Cube");
//            cube.transform.position = new Vector3(yExplosionPos/ FACTOR,TerrainGameBoard.terrainData.GetHeight(yExplosionPos,xExplosionPos),xExplosionPos/ FACTOR);
//            //TerrainGameBoard.terrainData.SetHeights(0,0,heights);
